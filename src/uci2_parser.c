...
{
       0,    89,    89,    98,   112,   116,   117,   121,   125,   134,
     147,   148,   152,   153
};
#endif
                 ...
                 yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, yyscan_t* scanner, uci2_parser_ctx_t* ctx)
{
  ...
  yy_symbol_value_print (yyo, yykind, yyvaluep, scanner, ctx);
  YYFPRINTF (yyo, ")");
}
  ...
  for (yyi = 0; yyi < yynrhs; yyi++)
    {
      ...
      yy_symbol_print (stderr,
                       ...
                       &yyvsp[(yyi + 1) - (yynrhs)], scanner, ctx);
      YYFPRINTF (stderr, "\n");
    }
}
...
#line 125 "uci2_cfg.y"
                              {  (yyval.node) = AST_NRC(UCI2_NT_TYPE, (yyvsp[-1].str), 0);
                                 ...
                                 AST_MOVCH((yyval.node), (yyvsp[0].node));
                                 // merge scattered list items into single
                                 // list node with list items
                                 AST_MERGE((yyval.node), UCI2_NT_LIST);
                              }
...
#line 1591 "uci2_parser.c"
    break;


#line 1595 "uci2_parser.c"
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  YY_ACCESSING_SYMBOL (yystate), yyvsp, scanner, ctx);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
  ...
  while (yyssp != yyss)
    {
      yydestruct ("Cleanup: popping",
                  YY_ACCESSING_SYMBOL (+*yyssp), yyvsp, scanner, ctx);
      YYPOPSTACK (1);
    }
#ifndef yyoverflow
  if (yyss != yyssa)
