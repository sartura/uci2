...
#line 129 "uci2_parser.c" /* yacc.c:315  */
...
#line 63 "uci2_cfg.y" /* yacc.c:352  */

    #include <uci2_ast.h>
    typedef void* yyscan_t;

#line 171 "uci2_parser.c" /* yacc.c:352  */
...
union YYSTYPE
{
#line 84 "uci2_cfg.y" /* yacc.c:352  */

    char* str;
    uci2_ast_t* node;

#line 196 "uci2_parser.c" /* yacc.c:352  */
};
...
{
       0,   105,   105,   116,   130,   134,   135,   139,   143,   156,
     169,   170,   174,   175
};
#endif
...
{
  "$end", "error", "$undefined", "VALUE", "CONFIG", "OPTION", "LIST",
  "PACKAGE", "$accept", "root", "package", "lines", "line", "config",
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, yyscan_t* scanner, uci2_parser_ctx_t* ctx)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (scanner);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, yyscan_t* scanner, uci2_parser_ctx_t* ctx)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, scanner, ctx);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, yyscan_t* scanner, uci2_parser_ctx_t* ctx)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, yyscan_t* scanner, uci2_parser_ctx_t* ctx)
{
  YYUSE (yyvaluep);
  YYUSE (scanner);
  YYUSE (ctx);
  ...
  switch (yytype)
    {
    case 3: /* VALUE  */
#line 97 "uci2_cfg.y" /* yacc.c:1257  */
      { free(((*yyvaluep).str)); }
#line 1037 "uci2_parser.c" /* yacc.c:1257  */
        break;
...
#line 78 "uci2_cfg.y" /* yacc.c:1431  */
{
    ctx->ast = 0;
    ctx->pool = uci2_new_ast(UCI2_NT_ROOT, 0, 0);
}

#line 1131 "uci2_parser.c" /* yacc.c:1431  */
  goto yysetstate;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 105 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_ROOT, strdup(UCI2_AST_ROOT), 0);
                ctx->ast = (yyval.node);
                // create cfg node
                AST_NP(UCI2_NT_CFG_GROUP, strdup(UCI2_AST_CFG), 0, (yyval.node));
                // use children from lines
                AST_MOVCH((yyval.node)->ch[0], (yyvsp[0].node));
                // merge same type nodes into a single node
                AST_MERGE((yyval.node)->ch[0], UCI2_NT_TYPE);
                // set indexes
                uci2_ast_set_indexes((yyval.node));
             }
#line 1327 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 3:
#line 116 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_ROOT, strdup(UCI2_AST_ROOT), 0);
                           ctx->ast = (yyval.node);
                           // package
                           AST_ACH((yyval.node), (yyvsp[-1].node));
                           // create cfg node
                           AST_NP(UCI2_NT_CFG_GROUP, strdup(UCI2_AST_CFG), 0, (yyval.node));
                           // use children from lines
                           AST_MOVCH((yyval.node)->ch[1], (yyvsp[0].node));
                           // merge same type nodes into a single node
                           AST_MERGE((yyval.node)->ch[1], UCI2_NT_TYPE);

                        }
#line 1344 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 4:
#line 130 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_PACKAGE, strdup(UCI2_AST_PKG), (yyvsp[0].str));  }
#line 1350 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 5:
#line 134 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_ROOT, 0, 0); AST_ACH((yyval.node), (yyvsp[0].node));  }
#line 1356 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 6:
#line 135 "uci2_cfg.y" /* yacc.c:1652  */
    {  AST_ACH((yyvsp[-1].node), (yyvsp[0].node));  }
#line 1362 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 7:
#line 139 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = (yyvsp[0].node);  }
#line 1368 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 8:
#line 143 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_TYPE, (yyvsp[-1].str), 0);
                                 // ** un-named section **
                                 // create new AST for unnamed section (index for name)
                                 char tmp_buff[33];
                                 sprintf(tmp_buff, "@[%d]", 9999);
                                 AST_NP(UCI2_NT_SECTION_NAME, strdup(tmp_buff), 0, (yyval.node));
...
#line 1386 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 9:
#line 156 "uci2_cfg.y" /* yacc.c:1652  */
...
#line 1402 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 10:
#line 169 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_SECTION, 0, 0); AST_ACH((yyval.node), (yyvsp[0].node));  }
#line 1408 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 11:
#line 170 "uci2_cfg.y" /* yacc.c:1652  */
    {  AST_ACH((yyvsp[-1].node), (yyvsp[0].node));  }
#line 1414 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 12:
#line 174 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_OPTION, (yyvsp[-1].str), (yyvsp[0].str));  }
#line 1420 "uci2_parser.c" /* yacc.c:1652  */
    break;

  case 13:
#line 175 "uci2_cfg.y" /* yacc.c:1652  */
    {  (yyval.node) = AST_NRC(UCI2_NT_LIST, (yyvsp[-1].str), 0); 
                             // add list value as new node
                             AST_NP(UCI2_NT_LIST_ITEM, (yyvsp[0].str), 0, (yyval.node));
                          }
#line 1429 "uci2_parser.c" /* yacc.c:1652  */
    break;


#line 1433 "uci2_parser.c" /* yacc.c:1652  */
      default: break;
    }
...
#line 181 "uci2_cfg.y" /* yacc.c:1918  */
